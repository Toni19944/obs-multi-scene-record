...
{
	return "Multi-Scene Record";
}
MODULE_EXPORT const char *obs_module_description(void)
{
	return "Independent per-scene recording and replay buffers";
}
...
static void dock_create_cb(enum obs_frontend_event event, void *)
{
	...
	obs_frontend_add_dock_by_id("multi_scene_record_dock", "Multi-Scene Record", g_dock);
}
